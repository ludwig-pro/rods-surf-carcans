...
const transferFeatures = [
  {
    id: 1,
    name: 'Coffee and meeting with your shaper',
    description:
  ...
  {
    id: 2,
    name: 'Draw together your model on the Shape 3D software',
    description:
      'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',
    icon: ScaleIcon,
  },
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <div className="mt-10 -mx-4 relative lg:mt-0" aria-hidden="true">
            ...
            <img
              ...
              width={490}
              src="https://images.unsplash.com/photo-1544840494-d0e48b117320?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3034&q=80"
              alt=""
            />
          </div>
        </div>
          ...
          <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            ...
            <div className="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
              ...
              <img
                className="relative mx-auto rounded-xl"
                width={490}
                src="https://images.unsplash.com/photo-1444069788560-6ae1deb4c0d4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3150&q=80"
                alt=""
              />
            </div>
          </div>
